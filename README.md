...
The intention of this project is to study whether rich people have an impact (whether that be good or bad)
on the local communities that they serve. To be quite honest, the only way to do this is through the Census (particularly with Microdata).
We can also do things involved with migration because of this. 
